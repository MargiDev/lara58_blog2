    ...
    <tr>
      <td>
        ...
        {!! Form::open(['style' => 'display:inline-block;', 'method' => 'DELETE', 'route' => ['backend.blog.force-destroy', $post->id]]) !!}
          <button title="Delete permanent" onclick="return confirm('You are about to delete this post permamently. Are you sure?')" type="submit" class="btn btn-xs btn-danger">
