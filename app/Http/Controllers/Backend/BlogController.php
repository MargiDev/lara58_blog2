...
class BlogController extends BackendController
{
  ...
  public function index(Request $request)
  {
    ...
    return view('backend.blog.index')->with(compact('posts', 'postCount', 'onlyTrashed', 'statusList'));
  }
  ...
  private function removeImage($image)
  {
    if( ! empty($image))
    {
      ...
      $thumbnail = str_replace(".{$ext}", "_thumb.{$ext}", $image); // Must use double quoat with {$ext}
      //dd($thumbnail);
